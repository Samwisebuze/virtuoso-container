...
//     after(async () => {
//         // TODO: cleanup by deleting any deployments still running
//     })
...
//         const [id, k8sId] = await K8Api.createDeployment(containerConfigs, 'dummy-network-id')
//         deploymentId = id
...
//     step('should run command in a contatiner in a deployment')
